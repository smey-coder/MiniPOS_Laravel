<nav x-data="{ open: false }" class="sticky top-0 z-50 backdrop-blur-xl bg-white/70 dark:bg-gray-900/60 border-b border-white/20 shadow-md">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('permissions.index')" :active="request()->routeIs('permission')">
                {{ __('Permissions') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
