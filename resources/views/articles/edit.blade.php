                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('articles.update', $article->id)}}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <textarea type="text" name="text" id="text" cols="30" rows="10" class="border-gray-300 shodow-sm w-1/2 rounded-lg" 
                                placeholder="Description">{{ old('text', $article->text) }}</textarea>
                                @error('text')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
